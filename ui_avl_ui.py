...
################################################################################
## Form generated from reading UI file 'avl_ui.ui'
##
...
class Ui_Form_avl(object):
    def setupUi(self, Form):
        ...
        self.delet.setGeometry(QRect(250, 250, 81, 41))
        self.label_6 = QLabel(Form)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(240, 260, 54, 16))
        self.label_2 = QLabel(Form)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(20, 260, 101, 31))
        font = QFont()
        ...
        self.english.setGeometry(QRect(120, 20, 121, 31))
        self.label_3 = QLabel(Form)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(20, 150, 101, 31))
        self.label_3.setFont(font)
        self.translate = QPushButton(Form)
        self.translate.setObjectName(u"translate")
        self.translate.setGeometry(QRect(250, 140, 81, 41))
        self.add = QPushButton(Form)
        self.add.setObjectName(u"add")
        self.add.setGeometry(QRect(250, 40, 81, 41))
        self.chinese = QLineEdit(Form)
        self.chinese.setObjectName(u"chinese")
        self.chinese.setGeometry(QRect(120, 70, 121, 31))
        self.delet_word = QLineEdit(Form)
        self.delet_word.setObjectName(u"delet_word")
        self.delet_word.setGeometry(QRect(120, 250, 121, 41))
        self.search_word = QLineEdit(Form)
        self.search_word.setObjectName(u"search_word")
        self.search_word.setGeometry(QRect(120, 140, 121, 41))
        self.search_word.setMouseTracking(False)
        self.search_word.setTabletTracking(False)
        self.label = QLabel(Form)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(20, 40, 111, 41))
        self.label.setFont(font)
        self.label_5 = QLabel(Form)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(240, 50, 21, 16))
        self.label_4 = QLabel(Form)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(240, 150, 21, 20))
        self.word_list = QListWidget(Form)
        self.word_list.setObjectName(u"word_list")
        self.word_list.setGeometry(QRect(340, 110, 151, 111))
        self.label_7 = QLabel(Form)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(0, 100, 491, 20))
        font1 = QFont()
        ...
        self.label_8.setGeometry(QRect(0, 210, 491, 20))
        self.label_8.setFont(font1)
        self.word_num = QLabel(Form)
        self.word_num.setObjectName(u"word_num")
        self.word_num.setGeometry(QRect(340, 10, 141, 21))
        font2 = QFont()
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"AVL", None))
